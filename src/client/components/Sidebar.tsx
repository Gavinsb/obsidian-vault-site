...
import {
  Home, Search, Clock, History, Star, ThumbsUp, Tag, Network, Map,
  Unlink, Folder, Activity, Shield, Settings, Plus, X,
} from 'lucide-react';
  ...
  return (
    <aside className={`sidebar${open ? ' open' : ''}`}>
      ...
      <div className="sidebar-footer">
        ...
        >
          <span className="nav-icon"><Plus size={16} strokeWidth={1.75} /></span>
          <span>New note</span>
        </button>
      </div>
    </aside>
