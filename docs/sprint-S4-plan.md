...
- **2026-09-20 — Released.** S4 implementation committed as `0cdfceb` ("Complete Sprint S4 secure editing and auth"); the completion record was committed separately and both commits were pushed to `origin/master`.
